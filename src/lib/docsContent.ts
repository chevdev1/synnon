    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          t("Sky weather: from time to time the sky behind the whole site turns to rain, snow or a thunderstorm with lightning, then clears again, like weather in a game. The stars also drift when you scroll, and the glow behind the brain follows your mouse. Call the weather yourself with /weather rain|snow|storm|clear in the console.", "Погода в небе: время от времени небо за всем сайтом затягивает дождём, снегом или грозой с молниями, а потом снова проясняет, как погоду в игре. Звёзды также плывут при прокрутке, а свечение за мозгом следует за мышкой. Вызвать погоду можно самому: /weather rain|snow|storm|clear в консоли."),
