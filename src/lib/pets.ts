...
export const PETS: Pet[] = [
  ...
  { id: "ember", name: { en: "Ember", ru: "Уголёк" }, color: "#ff8a4c", needs: "streak-week", hint: { en: "Keep a 7-day streak", ru: "Продержи серию 7 дней" }, rows: ["...o...", "..o#o..", "..###..", ".#o#o#.", ".##x##.", "..###..", "......."], perk: { name: { en: "Keeps the Flame", ru: "Хранит огонь" }, desc: { en: "Its glow grows with your daily streak: the longer you keep coming back, the brighter it burns.", ru: "Его свет растёт вместе с твоей серией дней: чем дольше ты возвращаешься, тем ярче он горит." } } },
